...
// Address: 0x3953Cc9d3e0ef9A7011436c39Fbe215bECFb574e
...
contract GetCookin is Ownable, ReentrancyGuard {
    ...
    event Tip(address indexed from, address indexed to, address indexed token, uint256 amount);
    ...
    function tip(uint256 tokenId, address tokenAddress, uint256 amount) external nonReentrant {
        ...
        totalTips[owner][tokenAddress] += amount;
        emit Tip(msg.sender, owner, tokenAddress, amount);
    }
